...
> OBJECT_DIRECTION_DEFINITION (ENUM) [
  'internal',
  'external',
];
...
gateway_id:N (outbound)   |     | gateway_id:N (inbound)
...
- Імплементація SFCGAL для адаптера бази даних            [@]
  _дозволить зберігати криву/плавну
  геометрію в `GEOMETRY`_

- Інтеграція Swagger до API сервісу                       [@]
  _дозволить структуровано описувати
